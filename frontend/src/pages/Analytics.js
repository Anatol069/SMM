                ...
                <div className="chart-card">
                    ...
                    <div className="chart-placeholder">
                        <svg viewBox="0 0 400 200" className="mini-chart">
                            <polyline points="10,180 50,140 90,160 130,100 170,120 210,80 250,95 290,50 330,70 370,30"
                    ...
                    <div className="audience-card">
                        ...
                        <div className="demographics">
                            <div className="demo-item">
                                <span>Age 18-24</span>
                                <div className="demo-bar"><div style={{ width: '45%' }}></div></div>
                            </div>
                            <div className="demo-item">
                                <span>Age 25-34</span>
                                <div className="demo-bar"><div style={{ width: '35%' }}></div></div>
                            </div>
                            <div className="demo-item">
                                <span>Age 35+</span>
                                <div className="demo-bar"><div style={{ width: '20%' }}></div></div>
                            </div>
                        </div>
                    </div>
                </div>
