            ...
            <div className="settings-container">
                ...
                <div className="settings-content">
                    <div className="settings-section">
                        ...
                        <div className="form-group">
                            <label>Email</label>
                            <input type="email" placeholder="your@email.com" defaultValue="anatol.burladean@gmail.com" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="toggle-group">
                            <div className="toggle-item">
                                <div>
                                    ...
                                    <p className="toggle-description">Receive notifications about posts and comments</p>
                                </div>
